...
const QUICK_LINKS = [
  ...
  { to: '/assistant', title: 'Ask Kharcha', description: 'Recipes, budget advice and shopping help.', icon: Bot, accent: 'bg-white text-saffron-600 border border-saffron-200 dark:bg-gray-900 dark:text-saffron-300 dark:border-saffron-900/40' },
];
